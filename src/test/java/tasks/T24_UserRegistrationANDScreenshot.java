...
public class T24_UserRegistrationANDScreenshot extends TestBase {
...
//    Capture a screenshot of the page with confetti.
    ...
    public void userRegistrationAndScreenshot() throws InterruptedException {
        ...
        driver.findElement(By.id("first-name")).sendKeys("Ibtihaj");
        driver.findElement(By.id("last-name")).sendKeys("Alyabsi");
        driver.findElement(By.id("address")).sendKeys("123 Street");
        driver.findElement(By.id("phone")).sendKeys("1234567890");
        driver.findElement(By.id("username")).sendKeys("ibtihaj2025");
        driver.findElement(By.id("email")).sendKeys("ibtihaj@gmail.com");
